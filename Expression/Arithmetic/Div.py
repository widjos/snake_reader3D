    ...
    def compile(self, environement: Environment) -> Value:
        ...
        if leftValue.type == typeExpression.INT:
                ...
                errorList.append(
                    {
                        ...
                        "descripcion" : f'El tipo de dato {rightValue.type} no es valido para realizar la division' , 
                        "fila":  self.row , 
                        "columna": self.column 
                    }) 
            ...
            errorList.append(
                    {
                        "tipo":"Error Semantico", 
                        "descripcion" : f'El tipo de dato {leftValue.type} no es valido para realizar la division' , 
                        "fila":  self.row , 
                        "columna": self.column 
                    })
            return Value("0",False,typeExpression.INT)