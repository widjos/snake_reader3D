    ...
    def compile(self, environement: Environment) -> Value:
        ...
        if leftValue.type == typeExpression.INT:
                ...
                errorList.append(
                    {
                        ...
                        "descripcion" : f'El tipo de dato {rightValue.type} no es valido para realizar la multiplicacion' , 
                        "fila":  rightValue.row , 
            ...
            errorList.append(
                    {
                        "tipo":"Error Semantico", 
                        "descripcion" : f'El tipo de dato {leftValue.type} no es valido para realizar la multiplicacion' , 
                        "fila":  leftValue.row , 
